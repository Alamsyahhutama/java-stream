...
public class GroupingByTest {
    ...
    void testGroupingBy2() {
        Map<String, List<String>> map = Stream.of("Alam", "Zikrul", "Ridwan", "Tio Angggie", "Alfan", "Arief Rahman", "Azman")
    ...
    void testPartitioningBy2() {
        Map<Boolean, List<String>> map = Stream.of("Alam", "Zikrul", "Ridwan", "Tio Angggie", "Alfan", "Arief Rahman", "Azman")
                .collect(Collectors.groupingBy(name -> {
